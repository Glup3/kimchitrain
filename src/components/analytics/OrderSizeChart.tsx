...
function ChartTooltip({
	...
	return (
		...
		>
			<p className="font-semibold text-[var(--sea-ink)]">{label} items</p>
...
export function OrderSizeChart({ data }: Props) {
	return (
		<div
		...
		>
			...
			<ResponsiveContainer width="100%" height={300}>
				<BarChart data={data} margin={{ left: 8, right: 16, top: 8, bottom: 0 }}>
					...
					<Bar dataKey="count" fill="var(--palm)" radius={[6, 6, 0, 0]} barSize={28} />
				</BarChart>
			</ResponsiveContainer>
		</div>
	)
